...
% ---------- Slide 2: Outline ----------
% NOTE: only "Introduction" has real content so far; add teammates'
% \section{...} commands below as their parts are ready and this list
% (and the top navigation bar) will extend automatically.
\begin{frame}{Outline}
  \tableofcontents
\end{frame}
